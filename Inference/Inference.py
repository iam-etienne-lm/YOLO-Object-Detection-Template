...
if len(images_path)>0:
    ...
    ascii_banner = pyfiglet.figlet_format("Importing Model", font='slant', justify='center', width=110)
    print(ascii_banner)
    
    model = run_model(weights=weights_path)
    times = []
    
    ascii_banner = pyfiglet.figlet_format("Computing predictions", font='slant', justify='center', width=110)
    print(ascii_banner)

    conf_thres_banner = pyfiglet.figlet_format("Conf threshold : {}".format(conf_thres), font='slant', justify='center', width=110)
    print(conf_thres_banner)
    ...
    ascii_banner = pyfiglet.figlet_format("Saving images", font='slant', justify='center', width=110)
    print(ascii_banner)
